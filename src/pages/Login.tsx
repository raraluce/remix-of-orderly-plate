    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6">
      ...
      >
        ...
        <div className="text-center">
          <div className="w-16 h-16 rounded-2xl gradient-accent flex items-center justify-center glow-accent mx-auto mb-5">
            <span className="text-2xl font-display font-bold text-primary-foreground">.b</span>
          </div>
          <h1 className="text-3xl font-display font-bold">
            Welcome back
          </h1>
          <p className="text-muted-foreground text-sm mt-1">Sign in to your <span className="text-gradient font-semibold">.bite</span> account</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 pr-10 h-13 rounded-xl bg-card border-border"
            />
            <button
              type="button"
